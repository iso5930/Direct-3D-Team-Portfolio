...
CMonk_Male_1HT_DashingStrike::CMonk_Male_1HT_DashingStrike()
{
	m_eStateType = STATE_TYPE_MONK_MALE_1HT_DASHINGSTRIKE;
}

CMonk_Male_1HT_DashingStrike::~CMonk_Male_1HT_DashingStrike(void)
{
}

void CMonk_Male_1HT_DashingStrike::Initialize()
{
...
CPlayerState* CMonk_Male_1HT_DashingStrike::Action()
{
