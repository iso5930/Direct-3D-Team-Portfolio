...
CMonk_Male_DW_FF_Mez::CMonk_Male_DW_FF_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_FF_MEZ;
...
CMonk_Male_DW_FF_Mez::~CMonk_Male_DW_FF_Mez(void)
{
}

void CMonk_Male_DW_FF_Mez::Initialize()
{
...
CPlayerState* CMonk_Male_DW_FF_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CMonk_Male_DW_FF_Mez::Mode0()
{
...
CPlayerState* CMonk_Male_DW_FF_Mez::Mode1()
{
	return new CMonk_Male_DW_FF_Knockback(m_vPos, 1000.f);
}

CPlayerState* CMonk_Male_DW_FF_Mez::Mode2()
{
	return new CMonk_Male_DW_FF_Knockback(m_vPos, 1000.f);
}

CPlayerState* CMonk_Male_DW_FF_Mez::Mode3()
{
...
CPlayerState* CMonk_Male_DW_FF_Mez::SlotAction(int _iIndex)
{
...
bool CMonk_Male_DW_FF_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
