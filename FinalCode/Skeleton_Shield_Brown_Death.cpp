...
CSkeleton_Shield_Brown_Death::CSkeleton_Shield_Brown_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_SHIELD_BROWN_DEATH;
...
void CSkeleton_Shield_Brown_Death::Initialize()
{
...
CMonsterState* CSkeleton_Shield_Brown_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
