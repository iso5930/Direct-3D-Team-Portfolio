...
CWitchDoctor_Male_Bow_Run::CWitchDoctor_Male_Bow_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_BOW_RUN;

	// SlotPush
	m_iSlotPush = _iSlotPush;
}

CWitchDoctor_Male_Bow_Run::~CWitchDoctor_Male_Bow_Run(void)
{
}

void CWitchDoctor_Male_Bow_Run::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_Bow_Run::Action()
{
...
CPlayerState* CWitchDoctor_Male_Bow_Run::Mode0()
{
	// Dir
...
CPlayerState* CWitchDoctor_Male_Bow_Run::Mode1()
{
...
CPlayerState* CWitchDoctor_Male_Bow_Run::SlotAction(int _iIndex)
{
...
bool CWitchDoctor_Male_Bow_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
