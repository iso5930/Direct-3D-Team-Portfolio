...
CMonk_Male_2HT_Mez::CMonk_Male_2HT_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_MONK_MALE_2HT_MEZ;
...
CMonk_Male_2HT_Mez::~CMonk_Male_2HT_Mez(void)
{
}

void CMonk_Male_2HT_Mez::Initialize()
{
...
CPlayerState* CMonk_Male_2HT_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CMonk_Male_2HT_Mez::Mode0()
{
...
CPlayerState* CMonk_Male_2HT_Mez::Mode1()
{
	return new CMonk_Male_2HT_Knockback(m_vPos, 1000.f);
}

CPlayerState* CMonk_Male_2HT_Mez::Mode2()
{
	return new CMonk_Male_2HT_Knockback(m_vPos, 1000.f);
}

CPlayerState* CMonk_Male_2HT_Mez::Mode3()
{
...
CPlayerState* CMonk_Male_2HT_Mez::SlotAction(int _iIndex)
{
	...
	case SLOT_ID_MONK_FISTS_OF_THUNDER:						// 천둥주먹
		return new CMonk_Male_2HT_Lightning_01;
	case SLOT_ID_MONK_DEADLY_REACH: 						// 연속 격파
		return new CMonk_Male_2HT_LongReach_01;
	case SLOT_ID_MONK_CRIPPLING_WAVE: 						// 마비의 파동
		return new CMonk_Male_2HT_DebilitatingBlows_01;
	case SLOT_ID_MONK_WAY_OF_THE_HUNDRED_FISTS: 			// 천지권법
		return new CMonk_Male_2HT_RapidStrikes_01;
	case SLOT_ID_MONK_PUNCH: 								// 주먹질
		return new CMonk_Male_2HT_Attack;
	...
	case SLOT_ID_MONK_LASHING_TAIL_KICK: 					// 반달차기
		return new CMonk_Male_2HT_LashingTail;	
	case SLOT_ID_MONK_TEMPEST_RUSH: 						// 폭풍 질주
		return new CMonk_Male_2HT_Hobble_Run(_iIndex);
	case SLOT_ID_MONK_WAVE_OF_LIGHT: 						// 빛의 파동
		return new CMonk_Male_2HT_WaveofLight;	
	case SLOT_ID_MONK_BLINDING_FLASH: 						// 눈부신 섬광
		return new CMonk_Male_2HT_Buff;
	...
	case SLOT_ID_MONK_DASHING_STRIKE: 						// 진격타
		return new CMonk_Male_2HT_DashingStrike;	
	case SLOT_ID_MONK_EXPLODING_PALM: 						// 폭발 장법
		return new CMonk_Male_2HT_Attack;	
	case SLOT_ID_MONK_SWEEPING_WIND: 						// 휘몰이
		return new CMonk_Male_2HT_CelestialWheel;
	case SLOT_ID_MONK_CYCLONE_STRIKE: 						// 용오름
		return new CMonk_Male_2HT_Lethal_Decoy;
...
bool CMonk_Male_2HT_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
