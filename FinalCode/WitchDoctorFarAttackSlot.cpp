...
CWitchDoctorFarAttackSlot::CWitchDoctorFarAttackSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_WITCHDOCTOR_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_WITCHDOCTOR_FAR_ATTACK;
...
SLOT_RESULT CWitchDoctorFarAttackSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
	...
	// Check Weapon
	DWORD dwFar = WEAPON_ID_BOW | WEAPON_ID_CROSSBOW;
...
SLOT_RESULT CWitchDoctorFarAttackSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CWitchDoctorFarAttackSlot::End()
{
	return SLOT_RESULT_NULL;
}
