...
CDemonHunter_Caltrops_FireEffect::CDemonHunter_Caltrops_FireEffect(TCHAR* _tszObjKey, OBJ_TYPE _eObjType, CObject* _pOwner)
...
CDemonHunter_Caltrops_FireEffect::~CDemonHunter_Caltrops_FireEffect(void)
{
	Release();
}

void CDemonHunter_Caltrops_FireEffect::Initialize()
{
	CEffect::Initialize();
...
int CDemonHunter_Caltrops_FireEffect::Update()
{
	CEffect::Update();
...
void CDemonHunter_Caltrops_FireEffect::Render()
{
	CEffect::Render();
}

void CDemonHunter_Caltrops_FireEffect::Release()
{
