...
CGhoul_Run::CGhoul_Run(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_GHOUL_RUN;
...
CGhoul_Run::~CGhoul_Run(void)
{
}

void CGhoul_Run::Initialize()
{
...
CMonsterState* CGhoul_Run::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CGhoul_Run::Mode0()
{
	//비전투
	...
	if(m_pPathFindCom->IsMove(&vNextPos) != false)
	{
		...
		return new CGhoul_Idle;

	return NULL;
}

CMonsterState* CGhoul_Run::Mode1()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 80.0f)
	{
		...
		{
		case 0 :
			return new CGhoul_Attack1;
		case 1 :
			return new CGhoul_Attack2;
		}
...
CMonsterState* CGhoul_Run::Mode2()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
