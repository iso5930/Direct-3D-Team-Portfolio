...
CSkeleton_Axe_Red_Run::CSkeleton_Axe_Red_Run(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_AXE_RED_RUN;
...
CSkeleton_Axe_Red_Run::~CSkeleton_Axe_Red_Run(void)
{
}

void CSkeleton_Axe_Red_Run::Initialize()
{
...
CMonsterState* CSkeleton_Axe_Red_Run::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CSkeleton_Axe_Red_Run::Mode0()
{
	//비전투
...
CMonsterState* CSkeleton_Axe_Red_Run::Mode1()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 80.0f)
	{
		...
		{
		case 0 :
			return new CSkeleton_Axe_Red_Attack1;
		case 1 :
			return new CSkeleton_Axe_Red_Attack2;
		}
...
CMonsterState* CSkeleton_Axe_Red_Run::Mode2()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
