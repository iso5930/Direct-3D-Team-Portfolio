...
CMonk_Male_DW_SS_DashingStrike::CMonk_Male_DW_SS_DashingStrike()
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_SS_DASHINGSTRIKE;
}

CMonk_Male_DW_SS_DashingStrike::~CMonk_Male_DW_SS_DashingStrike(void)
{
}

void CMonk_Male_DW_SS_DashingStrike::Initialize()
{
...
CPlayerState* CMonk_Male_DW_SS_DashingStrike::Action()
{
