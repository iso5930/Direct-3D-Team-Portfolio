...
CZombie_Skinny_Male_White_Death::CZombie_Skinny_Male_White_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_ZOMBIE_SKINNY_MALE_WHITE_DEATH;
...
void CZombie_Skinny_Male_White_Death::Initialize()
{
...
CMonsterState* CZombie_Skinny_Male_White_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
