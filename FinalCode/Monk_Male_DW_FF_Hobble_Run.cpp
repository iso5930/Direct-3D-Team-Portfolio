...
CMonk_Male_DW_FF_Hobble_Run::CMonk_Male_DW_FF_Hobble_Run(int _iPushSlot)
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_FF_HOBBLE_RUN;
...
CMonk_Male_DW_FF_Hobble_Run::~CMonk_Male_DW_FF_Hobble_Run(void)
{
	m_pOwner->GetSlot(m_iPushSlot)->End();
}

void CMonk_Male_DW_FF_Hobble_Run::Initialize()
{
...
CPlayerState* CMonk_Male_DW_FF_Hobble_Run::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CPlayerState* CMonk_Male_DW_FF_Hobble_Run::Mode0()
{
...
CPlayerState* CMonk_Male_DW_FF_Hobble_Run::Mode1()
{
	return new CMonk_Male_DW_FF_Idle;
}

CPlayerState* CMonk_Male_DW_FF_Hobble_Run::SlotAction(int _iIndex)
{
