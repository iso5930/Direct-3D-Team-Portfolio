...
CBarbarianNearAttackSlot::CBarbarianNearAttackSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_NEAR_ATTACK;
...
SLOT_RESULT CBarbarianNearAttackSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianNearAttackSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianNearAttackSlot::End()
{
	return SLOT_RESULT_NULL;
}
