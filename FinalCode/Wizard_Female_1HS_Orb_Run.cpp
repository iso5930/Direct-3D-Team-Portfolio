...
CWizard_Female_1HS_Orb_Run::CWizard_Female_1HS_Orb_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_1HS_ORB_RUN;

	// SlotPush
	m_iSlotPush = _iSlotPush;
}

CWizard_Female_1HS_Orb_Run::~CWizard_Female_1HS_Orb_Run(void)
{
}

void CWizard_Female_1HS_Orb_Run::Initialize()
{
...
CPlayerState* CWizard_Female_1HS_Orb_Run::Action()
{
...
CPlayerState* CWizard_Female_1HS_Orb_Run::Mode0()
{
	// Dir
...
CPlayerState* CWizard_Female_1HS_Orb_Run::Mode1()
{
...
CPlayerState* CWizard_Female_1HS_Orb_Run::SlotAction(int _iIndex)
{
...
bool CWizard_Female_1HS_Orb_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
