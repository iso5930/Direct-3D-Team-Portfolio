...
CWizard_Female_STF_Teleport::CWizard_Female_STF_Teleport(void)
{
	m_eStateType = 	STATE_TYPE_WIZARD_FEMALE_STF_TELEPORT;
...
void CWizard_Female_STF_Teleport::Initialize()
{
...
CPlayerState* CWizard_Female_STF_Teleport::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CPlayerState* CWizard_Female_STF_Teleport::Mode0()
{
...
CPlayerState* CWizard_Female_STF_Teleport::Mode1()
{
	++m_iMode;
...
CPlayerState* CWizard_Female_STF_Teleport::Mode2()
{
	m_pOwner->SetAnimationMode(0);
