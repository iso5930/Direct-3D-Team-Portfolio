...
CGhoul_Idle::CGhoul_Idle(void)
{
	// StateType
	m_eStateType = STATE_TYPE_GHOUL_IDLE;
...
void CGhoul_Idle::Initialize()
{
	CMonsterState::Initialize();
	m_pOwner->SetAnimation(0);

	CSoundMgr::GetInstance()->PlaySoundForMonster(_T("Ghoul_Idle.ogg"));
}

CMonsterState* CGhoul_Idle::Action()
{
	// Player
