...
CSkeleton_Summoner_Blue_Walk::CSkeleton_Summoner_Blue_Walk(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_SUMMONER_BLUE_WALK;
...
CSkeleton_Summoner_Blue_Walk::~CSkeleton_Summoner_Blue_Walk(void)
{
}

void CSkeleton_Summoner_Blue_Walk::Initialize()
{
...
CMonsterState* CSkeleton_Summoner_Blue_Walk::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CSkeleton_Summoner_Blue_Walk::Mode0()
{
	// 비전투
	// Player
	CObject* pPlayer = NULL;
	...
	{	
		return new CSkeleton_Summoner_Blue_Walk(1);
	}
	...
	if(m_pPathFindCom->IsMove(&vNextPos) != false)
	{
		...
		return new CSkeleton_Summoner_Blue_Idle(0);

	return NULL;
}

CMonsterState* CSkeleton_Summoner_Blue_Walk::Mode1()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 300.0f)
	{
		...
		{
		case 0 :
			return new CSkeleton_Summoner_Blue_Magic(0);
		case 1 :
			return new CSkeleton_Summoner_Blue_Summon;
		case 2 : 
			return new CSkeleton_Summoner_Blue_Magic(0);
		case 3 :
			return new CSkeleton_Summoner_Blue_Magic(0);
...
CMonsterState* CSkeleton_Summoner_Blue_Walk::Mode2()
{
	// 일정 거리 플레이어 접근시 백무빙
	...
	if(fDot > 0)
		return new CSkeleton_Summoner_Blue_Magic(1);
...
CMonsterState* CSkeleton_Summoner_Blue_Walk::Mode3()
{
	// 피격시 전투
	// Player
	CObject* pPlayer = NULL;
