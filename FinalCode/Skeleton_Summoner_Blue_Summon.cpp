...
CSkeleton_Summoner_Blue_Summon::CSkeleton_Summoner_Blue_Summon(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_SUMMONER_BLUE_SUMMON;
...
void CSkeleton_Summoner_Blue_Summon::Initialize()
{
...
CMonsterState* CSkeleton_Summoner_Blue_Summon::Action()
{
	// Player
	...
	if(!m_bEffect && m_pAnimController->GetTrackPos() > 2.343f)
	{
		...
		D3DXVec3TransformCoord(&pTransformCom->m_vPos, &pTransformCom->m_vPos, &((CSkeleton_Summoner_Blue*)m_pOwner)->m_RightHandBone.mWorld);
