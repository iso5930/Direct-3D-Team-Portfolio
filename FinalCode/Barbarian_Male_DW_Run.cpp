...
CBarbarian_Male_DW_Run::CBarbarian_Male_DW_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_DW_RUN;
...
CBarbarian_Male_DW_Run::~CBarbarian_Male_DW_Run(void)
{
}

void CBarbarian_Male_DW_Run::Initialize()
{
...
CPlayerState* CBarbarian_Male_DW_Run::Action()
{
	// SlotPush
...
CPlayerState* CBarbarian_Male_DW_Run::Mode0()
{
	// Dir
...
CPlayerState* CBarbarian_Male_DW_Run::Mode1()
{
...
CPlayerState* CBarbarian_Male_DW_Run::SlotAction(int _iIndex)
...
bool CBarbarian_Male_DW_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
