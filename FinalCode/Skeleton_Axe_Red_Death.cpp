...
CSkeleton_Axe_Red_Death::CSkeleton_Axe_Red_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_AXE_RED_DEATH;
...
void CSkeleton_Axe_Red_Death::Initialize()
{
...
CMonsterState* CSkeleton_Axe_Red_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
