...
CDemonHunter_Female_CB2_Mez::CDemonHunter_Female_CB2_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_CB2_MEZ;
...
CDemonHunter_Female_CB2_Mez::~CDemonHunter_Female_CB2_Mez(void)
{
}

void CDemonHunter_Female_CB2_Mez::Initialize()
{
...
CPlayerState* CDemonHunter_Female_CB2_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CDemonHunter_Female_CB2_Mez::Mode0()
{
...
CPlayerState* CDemonHunter_Female_CB2_Mez::Mode1()
{
	return new CDemonHunter_Female_CB2_Knockback(m_vPos, 1000.f);
}

CPlayerState* CDemonHunter_Female_CB2_Mez::Mode2()
{
	return new CDemonHunter_Female_CB2_Knockback(m_vPos, 1000.f);
}

CPlayerState* CDemonHunter_Female_CB2_Mez::Mode3()
{
...
CPlayerState* CDemonHunter_Female_CB2_Mez::SlotAction(int _iIndex)
{
	...
	case SLOT_ID_DEMONHUNTER_GRENADES:
		return new CDemonHunter_Female_CB2_Impale;
	...
	case SLOT_ID_DEMONHUNTER_SMOKE_SCREEN: // 연막
		return new CDemonHunter_Female_CB2_Buff;
	...
	case SLOT_ID_DEMONHUNTER_VAULT:  // 도약
		return new CDemonHunter_Female_CB2_BackFlip;

	case SLOT_ID_DEMONHUNTER_COMPANION: // 동료소환
		return new CDemonHunter_Female_CB2_Companion;

	case SLOT_ID_DEMONHUNTER_MARKED_FOR_DEATH: // 죽음의 표식
		return new CDemonHunter_Female_CB2_Caltrop;

	case SLOT_ID_DEMONHUNTER_SENTRY: // 자동쇠뇌
		return new CDemonHunter_Female_CB2_Caltrop;

	case SLOT_ID_DEMONHUNTER_FAN_OF_KNIVES:	//부채
		return new CDemonHunter_Female_CB2_FanOfKnives;
	...
	case SLOT_ID_DEMONHUNTER_BOLA:
		return new CDemonHunter_Female_CB2_MultiShot;	

	case SLOT_ID_DEMONHUNTER_EVASIVE_FIRE:
		return new CDemonHunter_Female_CB2_Attack_Right;

	case SLOT_ID_DEMONHUNTER_RAPID_FIRE:
		return new CDemonHunter_Female_CB2_BolaSlot(_iIndex);
	...
	case SLOT_ID_DEMONHUNTER_RAIN_OF_VENGEANCE:
		return new CDemonHunter_Female_CB2_RainOfArrow;

	case SLOT_ID_DEMONHUNTER_STRAFE:
		return new CDemonHunter_Female_CB2_Strafe(_iIndex);
...
bool CDemonHunter_Female_CB2_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
