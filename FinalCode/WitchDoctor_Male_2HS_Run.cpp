...
CWitchDoctor_Male_2HS_Run::CWitchDoctor_Male_2HS_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_2HS_RUN;
...
CWitchDoctor_Male_2HS_Run::~CWitchDoctor_Male_2HS_Run(void)
{
}

void CWitchDoctor_Male_2HS_Run::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_2HS_Run::Action()
{
...
CPlayerState* CWitchDoctor_Male_2HS_Run::Mode0()
{
	// Dir
...
CPlayerState* CWitchDoctor_Male_2HS_Run::Mode1()
{
...
CPlayerState* CWitchDoctor_Male_2HS_Run::SlotAction(int _iIndex)
{
...
bool CWitchDoctor_Male_2HS_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
