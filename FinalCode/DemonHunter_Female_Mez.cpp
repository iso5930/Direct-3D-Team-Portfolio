...
CDemonHunter_Female_Mez::CDemonHunter_Female_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_MEZ;
...
CDemonHunter_Female_Mez::~CDemonHunter_Female_Mez(void)
{
}

void CDemonHunter_Female_Mez::Initialize()
{
...
CPlayerState* CDemonHunter_Female_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CDemonHunter_Female_Mez::Mode0()
{
...
CPlayerState* CDemonHunter_Female_Mez::Mode1()
{
	return new CDemonHunter_Female_Knockback(m_vPos, 1000.f);
}

CPlayerState* CDemonHunter_Female_Mez::Mode2()
{
	return new CDemonHunter_Female_Knockback(m_vPos, 1000.f);
}

CPlayerState* CDemonHunter_Female_Mez::Mode3()
{
...
CPlayerState* CDemonHunter_Female_Mez::SlotAction(int _iIndex)
{
	...
	case SLOT_ID_DEMONHUNTER_SMOKE_SCREEN: // 연막
		return new CDemonHunter_Female_Buff;
	...
	case SLOT_ID_DEMONHUNTER_FAN_OF_KNIVES:	//부채
		return new CDemonHunter_Female_FanOfKnives;
...
bool CDemonHunter_Female_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
