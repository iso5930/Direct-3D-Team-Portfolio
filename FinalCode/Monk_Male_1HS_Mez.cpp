...
CMonk_Male_1HS_Mez::CMonk_Male_1HS_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_MONK_MALE_1HS_MEZ;
...
CMonk_Male_1HS_Mez::~CMonk_Male_1HS_Mez(void)
{
}

void CMonk_Male_1HS_Mez::Initialize()
{
...
CPlayerState* CMonk_Male_1HS_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CMonk_Male_1HS_Mez::Mode0()
{
...
CPlayerState* CMonk_Male_1HS_Mez::Mode1()
{
	return new CMonk_Male_1HS_Knockback(m_vPos , 1000.f);
}

CPlayerState* CMonk_Male_1HS_Mez::Mode2()
{
	return new CMonk_Male_1HS_Knockback(m_vPos , 1000.f);
}

CPlayerState* CMonk_Male_1HS_Mez::Mode3()
{
...
CPlayerState* CMonk_Male_1HS_Mez::SlotAction(int _iIndex)
{
...
bool CMonk_Male_1HS_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
