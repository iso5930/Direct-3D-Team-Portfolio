...
CBarbarian_Male_DW_Mez::CBarbarian_Male_DW_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_DW_MEZ;
...
CBarbarian_Male_DW_Mez::~CBarbarian_Male_DW_Mez(void)
{
}

void CBarbarian_Male_DW_Mez::Initialize()
{
...
CPlayerState* CBarbarian_Male_DW_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CBarbarian_Male_DW_Mez::Mode0()
{
...
CPlayerState* CBarbarian_Male_DW_Mez::Mode1()
{
	return new CBarbarian_Male_DW_Knockback_Loop(m_vPos, 1000.f);
}

CPlayerState* CBarbarian_Male_DW_Mez::Mode2()
{
	return new CBarbarian_Male_DW_Knockback_Loop(m_vPos, 1000.f);
}

CPlayerState* CBarbarian_Male_DW_Mez::Mode3()
{
...
CPlayerState* CBarbarian_Male_DW_Mez::SlotAction(int _iIndex)
{
...
bool CBarbarian_Male_DW_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
