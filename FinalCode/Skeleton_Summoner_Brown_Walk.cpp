...
CSkeleton_Summoner_Brown_Walk::CSkeleton_Summoner_Brown_Walk(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_SUMMONER_BROWN_WALK;
...
CSkeleton_Summoner_Brown_Walk::~CSkeleton_Summoner_Brown_Walk(void)
{
}

void CSkeleton_Summoner_Brown_Walk::Initialize()
{
...
CMonsterState* CSkeleton_Summoner_Brown_Walk::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CSkeleton_Summoner_Brown_Walk::Mode0()
{
	// Player
	CObject* pPlayer = NULL;
	m_pOwner->GetLayer()->FindObject(pPlayer, _T("Player"), LAYER_TYPE_PLAYER);
...
CMonsterState* CSkeleton_Summoner_Brown_Walk::Mode1()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
...
CMonsterState* CSkeleton_Summoner_Brown_Walk::Mode2()
{
...
CMonsterState* CSkeleton_Summoner_Brown_Walk::Mode3()
{
	// 피격시 전투
	// Player
	CObject* pPlayer = NULL;
