...
CBarbarian_Male_STF_Furious_Charge_Loop::CBarbarian_Male_STF_Furious_Charge_Loop(void)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_STF_FURIOUS_CHARGE_LOOP;
}
...
void CBarbarian_Male_STF_Furious_Charge_Loop::Initialize()
{
...
CPlayerState* CBarbarian_Male_STF_Furious_Charge_Loop::Action()
{
