...
CSkeleton_Archer_Mint_Walk::CSkeleton_Archer_Mint_Walk(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ARCHER_MINT_WALK;
}
...
void CSkeleton_Archer_Mint_Walk::Initialize()
{
...
CMonsterState* CSkeleton_Archer_Mint_Walk::Action()
{
	// Player
	CObject* pPlayer = NULL;
	m_pOwner->GetLayer()->FindObject(pPlayer, _T("Player"), LAYER_TYPE_PLAYER);
