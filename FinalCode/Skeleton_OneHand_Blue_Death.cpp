...
CSkeleton_OneHand_Blue_Death::CSkeleton_OneHand_Blue_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ONEHAND_BLUE_DEATH;
...
void CSkeleton_OneHand_Blue_Death::Initialize()
{
...
CMonsterState* CSkeleton_OneHand_Blue_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
