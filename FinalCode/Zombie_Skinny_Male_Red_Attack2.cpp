...
CZombie_Skinny_Male_Red_Attack2::CZombie_Skinny_Male_Red_Attack2(void)
{
	// StateType
	m_eStateType = STATE_TYPE_ZOMBIE_SKINNY_MALE_RED_ATTACK2;
...
void CZombie_Skinny_Male_Red_Attack2::Initialize()
{
...
CMonsterState* CZombie_Skinny_Male_Red_Attack2::Action()
{
...
CMonsterState* CZombie_Skinny_Male_Red_Attack2::Mode0()
{
...
CMonsterState* CZombie_Skinny_Male_Red_Attack2::Mode1()
{
	m_fTime += CTimeMgr::GetInstance()->GetDeltaTime();
	if(m_fTime > 1.f)
	{
