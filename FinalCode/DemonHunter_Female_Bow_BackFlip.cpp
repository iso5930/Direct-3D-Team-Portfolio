...
CDemonHunter_Female_Bow_BackFlip::CDemonHunter_Female_Bow_BackFlip()
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_BOW_BACKFLIP;
...
void CDemonHunter_Female_Bow_BackFlip::Initialize()
{
...
CPlayerState* CDemonHunter_Female_Bow_BackFlip::Action()
{
