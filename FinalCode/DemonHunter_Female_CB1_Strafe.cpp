...
CDemonHunter_Female_CB1_Strafe::CDemonHunter_Female_CB1_Strafe(int _iPushSlot)
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_CB1_STRAFE;
...
CDemonHunter_Female_CB1_Strafe::~CDemonHunter_Female_CB1_Strafe()
{
	m_pOwner->GetSlot(m_iPushSlot)->End();
}

void CDemonHunter_Female_CB1_Strafe::Initialize()
{
...
CPlayerState* CDemonHunter_Female_CB1_Strafe::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CPlayerState* CDemonHunter_Female_CB1_Strafe::Mode0()
{	
...
CPlayerState* CDemonHunter_Female_CB1_Strafe::Mode1()
{
	return new CDemonHunter_Female_CB1_Idle;
}

CPlayerState* CDemonHunter_Female_CB1_Strafe::SlotAction(int _iIndex)
{
