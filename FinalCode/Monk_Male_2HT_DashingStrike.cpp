...
CMonk_Male_2HT_DashingStrike::CMonk_Male_2HT_DashingStrike()
{
	m_eStateType = STATE_TYPE_MONK_MALE_2HT_DASHINGSTRIKE;
}

CMonk_Male_2HT_DashingStrike::~CMonk_Male_2HT_DashingStrike(void)
{
}

void CMonk_Male_2HT_DashingStrike::Initialize()
{
...
CPlayerState* CMonk_Male_2HT_DashingStrike::Action()
{
