...
CMonk_Male_1HT_Knockback::CMonk_Male_1HT_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_MONK_MALE_1HT_KNOCKBACK;
...
CMonk_Male_1HT_Knockback::~CMonk_Male_1HT_Knockback(void)
{
}

void CMonk_Male_1HT_Knockback::Initialize()
{
...
CPlayerState* CMonk_Male_1HT_Knockback::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CMonk_Male_1HT_Knockback_End;
	}
