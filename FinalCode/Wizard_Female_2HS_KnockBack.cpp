...
CWizard_Female_2HS_Knockback::CWizard_Female_2HS_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_2HS_KNOCKBACK;
...
CWizard_Female_2HS_Knockback::~CWizard_Female_2HS_Knockback(void)
{
}

void CWizard_Female_2HS_Knockback::Initialize()
{
...
CPlayerState* CWizard_Female_2HS_Knockback::Action()
{	
	...
	if (m_fTime > 0.1f )
	{
		return new CWizard_Female_2HS_KnockbackEnd;
	}
