...
CBarbarianWeaponThrowSlot::CBarbarianWeaponThrowSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_PRIMARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_WEAPON_THROW;
...
SLOT_RESULT CBarbarianWeaponThrowSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianWeaponThrowSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianWeaponThrowSlot::End()
{
	return SLOT_RESULT_NULL;
}
