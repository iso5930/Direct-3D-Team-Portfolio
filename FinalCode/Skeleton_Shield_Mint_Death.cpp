...
CSkeleton_Shield_Mint_Death::CSkeleton_Shield_Mint_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_SHIELD_MINT_DEATH;
...
void CSkeleton_Shield_Mint_Death::Initialize()
{
...
CMonsterState* CSkeleton_Shield_Mint_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
