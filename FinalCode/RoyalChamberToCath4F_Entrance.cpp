...
CRoyalChamberToCath4F_Entrance::CRoyalChamberToCath4F_Entrance(TCHAR* _tszObjKey, OBJ_TYPE _eObjType)
: CDynamicProb(_tszObjKey, _eObjType)
{
	...
	// ProbType
	m_eProbType = PROB_TYPE_ROYAL_CHAMBER_TO_CATH4F;

	// Mode
	m_iMode = 0;

	// Pos
	m_pTransformCom->m_vPos = D3DXVECTOR3(1904.15f, 14.4608f, 1766.73f);
...
CRoyalChamberToCath4F_Entrance::~CRoyalChamberToCath4F_Entrance()
{
	Release();
}

void CRoyalChamberToCath4F_Entrance::Initialize()
{
	CDynamicProb::Initialize();
}

int CRoyalChamberToCath4F_Entrance::Update()
{
	CDynamicProb::Update();
...
void CRoyalChamberToCath4F_Entrance::Render()
{
}

void CRoyalChamberToCath4F_Entrance::Release()
{
}

void CRoyalChamberToCath4F_Entrance::Event()
{
	// Mode
	m_iMode = 1;
...
void CRoyalChamberToCath4F_Entrance::EventEnd()
{
}

void CRoyalChamberToCath4F_Entrance::Mode0()
{
}

void CRoyalChamberToCath4F_Entrance::Mode1()
{
