...
CWitchDoctor_Male_2HT_Mez::CWitchDoctor_Male_2HT_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_2HT_MEZ;
...
CWitchDoctor_Male_2HT_Mez::~CWitchDoctor_Male_2HT_Mez(void)
{
}

void CWitchDoctor_Male_2HT_Mez::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_2HT_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CWitchDoctor_Male_2HT_Mez::Mode0()
{
...
CPlayerState* CWitchDoctor_Male_2HT_Mez::Mode1()
{
	return new CWitchDoctor_Male_2HT_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWitchDoctor_Male_2HT_Mez::Mode2()
{
	return new CWitchDoctor_Male_2HT_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWitchDoctor_Male_2HT_Mez::Mode3()
{
...
CPlayerState* CWitchDoctor_Male_2HT_Mez::SlotAction(int _iIndex)
{
...
bool CWitchDoctor_Male_2HT_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
