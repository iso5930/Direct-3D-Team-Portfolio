...
CWizard_Female_1HS_Idle::CWizard_Female_1HS_Idle(void)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_1HS_IDLE;
...
void CWizard_Female_1HS_Idle::Initialize()
{
...
CPlayerState* CWizard_Female_1HS_Idle::Action()
{
	for (int i = 0 ; i < SKILL_TYPE_END ; ++i)
	{
		if (m_pOwner->IsMez(i))
		{
			return new CWizard_Female_1HS_Mez(i , D3DXVECTOR3(0.f , 0.f , 0.f ));
		}
	}
...
CPlayerState* CWizard_Female_1HS_Idle::Mode0()
{
...
CPlayerState* CWizard_Female_1HS_Idle::Mode1()
{
...
CPlayerState* CWizard_Female_1HS_Idle::SlotAction(int _iIndex)
{
...
bool CWizard_Female_1HS_Idle::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
