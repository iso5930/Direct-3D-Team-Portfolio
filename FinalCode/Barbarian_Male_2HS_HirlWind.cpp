...
CBarbarian_Male_2HS_HirlWind::CBarbarian_Male_2HS_HirlWind(int _iPushSlot)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_2HS_HIRLWIND;
...
CBarbarian_Male_2HS_HirlWind::~CBarbarian_Male_2HS_HirlWind(void)
{
	m_pOwner->GetSlot(m_iPushSlot)->End();
}

void CBarbarian_Male_2HS_HirlWind::Initialize()
{
...
CPlayerState* CBarbarian_Male_2HS_HirlWind::Action()
{
...
CPlayerState* CBarbarian_Male_2HS_HirlWind::Mode0()
{
	if(m_pAnimController->m_dFrameTime <= m_pAnimController->GetTrackPos())
	{
		return new CBarbarian_Male_2HS_HirlWind(m_iPushSlot);
	}
...
CPlayerState* CBarbarian_Male_2HS_HirlWind::Mode1()
{
	return new CBarbarian_Male_2HS_Idle;
}

CPlayerState* CBarbarian_Male_2HS_HirlWind::SlotAction(int _iIndex)
{
