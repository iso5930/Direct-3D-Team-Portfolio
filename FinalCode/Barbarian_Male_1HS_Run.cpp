...
CBarbarian_Male_1HS_Run::CBarbarian_Male_1HS_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_1HS_RUN;

	m_iSlotPush = _iSlotPush;
}

CBarbarian_Male_1HS_Run::~CBarbarian_Male_1HS_Run(void)
{
}

void CBarbarian_Male_1HS_Run::Initialize()
{
...
CPlayerState* CBarbarian_Male_1HS_Run::Action()
{
...
CPlayerState* CBarbarian_Male_1HS_Run::Mode0()
{
	// Dir
	...
	// Find Priority Key and SlotNoasd
...
CPlayerState* CBarbarian_Male_1HS_Run::Mode1()
{	
...
CPlayerState* CBarbarian_Male_1HS_Run::SlotAction(int _iIndex)
{
...
bool CBarbarian_Male_1HS_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
