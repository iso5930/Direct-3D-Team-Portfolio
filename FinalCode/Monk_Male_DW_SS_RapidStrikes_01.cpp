...
CMonk_Male_DW_SS_RapidStrikes_01::CMonk_Male_DW_SS_RapidStrikes_01(void)
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_SS_RAPIDSTRIKES_01;
...
void CMonk_Male_DW_SS_RapidStrikes_01::Initialize()
{
...
CPlayerState* CMonk_Male_DW_SS_RapidStrikes_01::Action()
{
	switch(m_iMode)
	{
...
CPlayerState* CMonk_Male_DW_SS_RapidStrikes_01::Mode0()
{
	...
	{		
		...
		{
			return new CMonk_Male_DW_SS_RapidStrikes_02;
		}
		else
		{
...
CPlayerState* CMonk_Male_DW_SS_RapidStrikes_01::Mode1()
{
...
CPlayerState* CMonk_Male_DW_SS_RapidStrikes_01::Mode2()
{
	if(m_pAnimController->m_dFrameTime - 0.2 <= m_pAnimController->GetTrackPos())
	{
		if (m_pOwner->GetSlot(m_iSlotNum)->GetSlotID() == SLOT_ID_MONK_WAY_OF_THE_HUNDRED_FISTS && 	m_pOwner->GetSlot(m_iSlotNum)->Begin(0) == SLOT_RESULT_NULL)
