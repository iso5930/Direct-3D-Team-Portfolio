...
CZombie_Skinny_Male_Red_Attack1::CZombie_Skinny_Male_Red_Attack1(void)
{
	// StateType
	m_eStateType = STATE_TYPE_ZOMBIE_SKINNY_MALE_RED_ATTACK1;
...
void CZombie_Skinny_Male_Red_Attack1::Initialize()
{
...
CMonsterState* CZombie_Skinny_Male_Red_Attack1::Action()
{
...
CMonsterState* CZombie_Skinny_Male_Red_Attack1::Mode0()
{
...
CMonsterState* CZombie_Skinny_Male_Red_Attack1::Mode1()
{
	m_fTime += CTimeMgr::GetInstance()->GetDeltaTime();
	if(m_fTime > 1.0f)
	{
