...
CSkeleton_OneHand_Brown_Death::CSkeleton_OneHand_Brown_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ONEHAND_BROWN_DEATH;
...
void CSkeleton_OneHand_Brown_Death::Initialize()
{
...
CMonsterState* CSkeleton_OneHand_Brown_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
