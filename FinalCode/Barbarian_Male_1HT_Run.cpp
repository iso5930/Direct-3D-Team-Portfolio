...
CBarbarian_Male_1HT_Run::CBarbarian_Male_1HT_Run(int _iSlotPush)
{
...
CBarbarian_Male_1HT_Run::~CBarbarian_Male_1HT_Run(void)
{
}

void CBarbarian_Male_1HT_Run::Initialize()
{
...
CPlayerState* CBarbarian_Male_1HT_Run::Action()
{
...
CPlayerState* CBarbarian_Male_1HT_Run::Mode0()
{
	// Dir
...
CPlayerState* CBarbarian_Male_1HT_Run::Mode1()
{
...
CPlayerState* CBarbarian_Male_1HT_Run::SlotAction(int _iIndex)
{
...
bool CBarbarian_Male_1HT_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
