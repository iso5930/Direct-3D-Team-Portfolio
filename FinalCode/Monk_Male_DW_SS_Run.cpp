...
CMonk_Male_DW_SS_Run::CMonk_Male_DW_SS_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_SS_RUN;

	//SlotPush
	m_iSlotPush	=  _iSlotPush;
}

CMonk_Male_DW_SS_Run::~CMonk_Male_DW_SS_Run(void)
{
}

void CMonk_Male_DW_SS_Run::Initialize()
{
...
CPlayerState* CMonk_Male_DW_SS_Run::Action()
{
...
CPlayerState* CMonk_Male_DW_SS_Run::Mode0()
{
	// Dir
...
CPlayerState* CMonk_Male_DW_SS_Run::Mode1()
{
...
CPlayerState* CMonk_Male_DW_SS_Run::SlotAction(int _iIndex)
{
...
bool CMonk_Male_DW_SS_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
