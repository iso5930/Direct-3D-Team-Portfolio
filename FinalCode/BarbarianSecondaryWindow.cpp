...
: CWindowUI(_tszObjKey, _eObjType, _T("Window_Barbarian_Secondary"))
{
	...
	_tcscpy_s(m_tszName[0], MIN_STR, _T("선조의 망치"));
	_tcscpy_s(m_tszName[1], MIN_STR, _T("분쇄"));
	_tcscpy_s(m_tszName[2], MIN_STR, _T("대지 강타"));
	_tcscpy_s(m_tszName[3], MIN_STR, _T("소용돌이"));
	_tcscpy_s(m_tszName[4], MIN_STR, _T("고대의 작살"));
