...
CWizard_Female_XBow_Run::CWizard_Female_XBow_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_XBOW_RUN;
...
CWizard_Female_XBow_Run::~CWizard_Female_XBow_Run(void)
{
}

void CWizard_Female_XBow_Run::Initialize()
{
...
CPlayerState* CWizard_Female_XBow_Run::Action()
{
...
CPlayerState* CWizard_Female_XBow_Run::Mode0()
{
	// Dir
...
CPlayerState* CWizard_Female_XBow_Run::Mode1()
{
...
CPlayerState* CWizard_Female_XBow_Run::SlotAction(int _iIndex)
{
...
bool CWizard_Female_XBow_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
