...
CSkeleton_OneHand_Blue_Run::CSkeleton_OneHand_Blue_Run(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ONEHAND_BLUE_RUN;
...
CSkeleton_OneHand_Blue_Run::~CSkeleton_OneHand_Blue_Run(void)
{
}

void CSkeleton_OneHand_Blue_Run::Initialize()
{
...
CMonsterState* CSkeleton_OneHand_Blue_Run::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CSkeleton_OneHand_Blue_Run::Mode0()
{
	//비전투
...
CMonsterState* CSkeleton_OneHand_Blue_Run::Mode1()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 80.0f)
	{
		...
		return new CSkeleton_OneHand_Blue_Attack;
	}
...
CMonsterState* CSkeleton_OneHand_Blue_Run::Mode2()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
