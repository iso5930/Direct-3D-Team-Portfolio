...
CSkeleton_Shield_Red_Death::CSkeleton_Shield_Red_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_SHIELD_RED_DEATH;
...
void CSkeleton_Shield_Red_Death::Initialize()
{
...
CMonsterState* CSkeleton_Shield_Red_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
