...
CDemonHunterPunchSlot::CDemonHunterPunchSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_DEMONHUNTER_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_DEMONHUNTER_PUNCH;
...
SLOT_RESULT CDemonHunterPunchSlot::Begin(int _iMode)
{
	// Check Enable
	if(!m_bEnable)
	{
...
SLOT_RESULT CDemonHunterPunchSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CDemonHunterPunchSlot::End()
{
	return SLOT_RESULT_NULL;
}
