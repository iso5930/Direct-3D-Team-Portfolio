...
CBarbarianRendSlot::CBarbarianRendSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_REND;
...
SLOT_RESULT CBarbarianRendSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianRendSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianRendSlot::End()
{
	return SLOT_RESULT_NULL;
}
