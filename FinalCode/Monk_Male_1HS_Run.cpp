...
CMonk_Male_1HS_Run::CMonk_Male_1HS_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_MONK_MALE_1HS_RUN;
...
CMonk_Male_1HS_Run::~CMonk_Male_1HS_Run(void)
{
}

void CMonk_Male_1HS_Run::Initialize()
{
...
CPlayerState* CMonk_Male_1HS_Run::Action()
{
...
CPlayerState* CMonk_Male_1HS_Run::Mode0()
{
	// Dir
...
CPlayerState* CMonk_Male_1HS_Run::Mode1()
{
...
CPlayerState* CMonk_Male_1HS_Run::SlotAction(int _iIndex)
{
...
bool CMonk_Male_1HS_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
