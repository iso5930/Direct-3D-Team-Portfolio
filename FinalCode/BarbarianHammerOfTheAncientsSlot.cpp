...
CBarbarianHammerOfTheAncientsSlot::CBarbarianHammerOfTheAncientsSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_HAMMER_OF_THE_ANCIENTS;
...
SLOT_RESULT CBarbarianHammerOfTheAncientsSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianHammerOfTheAncientsSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianHammerOfTheAncientsSlot::End()
{
	return SLOT_RESULT_NULL;
}
