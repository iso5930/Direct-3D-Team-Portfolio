...
CDemonHunter_Female_CB1_Knockback::CDemonHunter_Female_CB1_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_CB1_KNOCKBACK;
...
CDemonHunter_Female_CB1_Knockback::~CDemonHunter_Female_CB1_Knockback()
{
}

void CDemonHunter_Female_CB1_Knockback::Initialize()
{
...
CPlayerState* CDemonHunter_Female_CB1_Knockback::Action()
{
