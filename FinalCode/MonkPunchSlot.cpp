...
CMonkPunchSlot::CMonkPunchSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_MONK_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_MONK_PUNCH;
...
SLOT_RESULT CMonkPunchSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CMonkPunchSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CMonkPunchSlot::End()
{
	return SLOT_RESULT_NULL;
}
