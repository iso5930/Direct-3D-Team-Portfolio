...
CWitchDoctorFirebombSlot::CWitchDoctorFirebombSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_WITCHDOCTOR_PRIMARY;

	// SlotID
	m_eSlotID = SLOT_ID_WITCHDOCTOR_FIREBOMB;
...
SLOT_RESULT CWitchDoctorFirebombSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CWitchDoctorFirebombSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CWitchDoctorFirebombSlot::End()
{
	return SLOT_RESULT_NULL;
}
