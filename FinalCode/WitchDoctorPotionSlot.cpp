...
CWitchDoctorPotionSlot::CWitchDoctorPotionSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_END;

	// SlotID
	m_eSlotID = SLOT_ID_WITCHDOCTOR_POTION;
...
SLOT_RESULT CWitchDoctorPotionSlot::Begin(int _iMode)
{
	// Check Enable
	if(m_bEnable == false)
	{
...
SLOT_RESULT CWitchDoctorPotionSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CWitchDoctorPotionSlot::End()
{
	return SLOT_RESULT_NULL;
}