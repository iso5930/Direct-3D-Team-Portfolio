...
CBarbarianRevengeSlot::CBarbarianRevengeSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_MIGHT;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_REVENGE;
...
SLOT_RESULT CBarbarianRevengeSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianRevengeSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianRevengeSlot::End()
{
	return SLOT_RESULT_NULL;
}
