...
CBarbarian_Male_STF_Run ::CBarbarian_Male_STF_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_STF_RUN;
...
CBarbarian_Male_STF_Run ::~CBarbarian_Male_STF_Run (void)
{
}

void CBarbarian_Male_STF_Run ::Initialize()
{
...
CPlayerState* CBarbarian_Male_STF_Run ::Action()
{
...
CPlayerState* CBarbarian_Male_STF_Run::Mode0()
{
	// Dir
...
CPlayerState* CBarbarian_Male_STF_Run::Mode1()
{
...
CPlayerState* CBarbarian_Male_STF_Run::SlotAction(int _iIndex)
{
...
bool CBarbarian_Male_STF_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
