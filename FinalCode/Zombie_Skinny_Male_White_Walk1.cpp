...
CZombie_Skinny_Male_White_Walk1::CZombie_Skinny_Male_White_Walk1(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_ZOMBIE_SKINNY_MALE_WHITE_WALK1;
...
CZombie_Skinny_Male_White_Walk1::~CZombie_Skinny_Male_White_Walk1(void)
{
}

void CZombie_Skinny_Male_White_Walk1::Initialize()
{
...
CMonsterState* CZombie_Skinny_Male_White_Walk1::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CZombie_Skinny_Male_White_Walk1::Mode0()
{
	//비전투
...
CMonsterState* CZombie_Skinny_Male_White_Walk1::Mode1()
{	
	//전투
		...
		m_fWaitTime > 2.f)
	{
		...
		{
			m_fWaitTime = 0.0f;
			return new CZombie_Skinny_Male_White_Idle(1);
		}
	}
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 55.0f)
	{
		...
		return new CZombie_Skinny_Male_White_Idle(2);
	}
...
CMonsterState* CZombie_Skinny_Male_White_Walk1::Mode2()
{
	// Player
	CObject* pPlayer = NULL;
	m_pOwner->GetLayer()->FindObject(pPlayer, _T("Player"), LAYER_TYPE_PLAYER);
	...
	if(Equals(m_vHoverPos.x, m_pTransformCom->m_vPos.x, MAX_EPSILON) && Equals(m_vHoverPos.x, m_pTransformCom->m_vPos.x, MAX_EPSILON))
		return new CZombie_Skinny_Male_White_Idle(1); 
...
CMonsterState* CZombie_Skinny_Male_White_Walk1::Mode3()
{
	// Player
	CObject* pPlayer = NULL;
	m_pOwner->GetLayer()->FindObject(pPlayer, _T("Player"), LAYER_TYPE_PLAYER);
