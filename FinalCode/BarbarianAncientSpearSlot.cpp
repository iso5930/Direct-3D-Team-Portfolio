...
CBarbarianAncientSpearSlot::CBarbarianAncientSpearSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_ANCIENT_SPEAR;
...
SLOT_RESULT CBarbarianAncientSpearSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianAncientSpearSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianAncientSpearSlot::End()
{
	return SLOT_RESULT_NULL;
}
