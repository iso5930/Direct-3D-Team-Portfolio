...
CTriune_Berserker_Run::CTriune_Berserker_Run(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_TRIUNE_BERSERKER_RUN;
...
CTriune_Berserker_Run::~CTriune_Berserker_Run(void)
{
}


void CTriune_Berserker_Run::Initialize()
{	
...
CMonsterState* CTriune_Berserker_Run::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CTriune_Berserker_Run::Mode0()
{
	//비전투
	...
	if(m_pPathFindCom->IsMove(&vNextPos) != false)
	{
		...
		return new CTriune_Berserker_Idle;

	return NULL;
}

CMonsterState* CTriune_Berserker_Run::Mode1()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 80.0f)
	{
		...
		{
		case 0 :
			return new CTriune_Berserker_Attack1;
		case 1 :
			return new CTriune_Berserker_Attack2;
		}
...
CMonsterState* CTriune_Berserker_Run::Mode2()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
