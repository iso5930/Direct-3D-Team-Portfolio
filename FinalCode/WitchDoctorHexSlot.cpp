...
CWitchDoctorHexSlot::CWitchDoctorHexSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_WITCHDOCTOR_DEFENSIVE;

	// SlotID
	m_eSlotID = SLOT_ID_WITCHDOCTOR_HEX;
...
SLOT_RESULT CWitchDoctorHexSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CWitchDoctorHexSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CWitchDoctorHexSlot::End()
{
	return SLOT_RESULT_NULL;
}
