...
CWitchDoctor_Male_STF_Knockback::CWitchDoctor_Male_STF_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_STF_KNOCKBACK;
...
CWitchDoctor_Male_STF_Knockback::~CWitchDoctor_Male_STF_Knockback(void)
{
}

void CWitchDoctor_Male_STF_Knockback::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_STF_Knockback::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CWitchDoctor_Male_STF_Knockback_End;
	}
