...
CSkeleton_Archer_Brown_Run::CSkeleton_Archer_Brown_Run(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ARCHER_BROWN_RUN;
...
CSkeleton_Archer_Brown_Run::~CSkeleton_Archer_Brown_Run(void)
{
}

void CSkeleton_Archer_Brown_Run::Initialize()
{
...
CMonsterState* CSkeleton_Archer_Brown_Run::Action()
{	
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CSkeleton_Archer_Brown_Run::Mode0()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
...
CMonsterState* CSkeleton_Archer_Brown_Run::Mode1()
{
...
CMonsterState* CSkeleton_Archer_Brown_Run::Mode2()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
