...
CWizard_Female_1HS_Attack::CWizard_Female_1HS_Attack(void)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_1HS_ATTACK;
}
...
void CWizard_Female_1HS_Attack::Initialize()
{
...
CPlayerState* CWizard_Female_1HS_Attack::Action()
{
