...
CMonk_Male_1HS_DashingStrike::CMonk_Male_1HS_DashingStrike()
{
	m_eStateType = STATE_TYPE_MONK_MALE_1HS_DASHINGSTRIKE;
}

CMonk_Male_1HS_DashingStrike::~CMonk_Male_1HS_DashingStrike(void)
{
}

void CMonk_Male_1HS_DashingStrike::Initialize()
{
...
CPlayerState* CMonk_Male_1HS_DashingStrike::Action()
{
