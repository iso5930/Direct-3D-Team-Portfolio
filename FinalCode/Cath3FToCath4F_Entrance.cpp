...
CCath3FToCath4F_Entrance::CCath3FToCath4F_Entrance(TCHAR* _tszObjKey, OBJ_TYPE _eObjType)
: CDynamicProb(_tszObjKey, _eObjType)
{
	...
	// ProbType
	m_eProbType = PROB_TYPE_CATH3F_TO_CATH4F_DOOR;

	// Mode
	m_iMode = 0;

	// Pos
	m_pTransformCom->m_vPos = D3DXVECTOR3(1539.0f, -582.0f, 10334.0f);
...
CCath3FToCath4F_Entrance::~CCath3FToCath4F_Entrance()
{
	Release();
}

void CCath3FToCath4F_Entrance::Initialize()
{
	CDynamicProb::Initialize();
}

int CCath3FToCath4F_Entrance::Update()
{
	CDynamicProb::Update();
...
void CCath3FToCath4F_Entrance::Render()
{
}

void CCath3FToCath4F_Entrance::Release()
{
}

void CCath3FToCath4F_Entrance::Event()
{
	// Mode
	m_iMode = 1;
...
void CCath3FToCath4F_Entrance::EventEnd()
{
}

void CCath3FToCath4F_Entrance::Mode0()
{
}

void CCath3FToCath4F_Entrance::Mode1()
{
