...
CWizard_Female_2HS_Mez::CWizard_Female_2HS_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_2HS_MEZ;
...
CWizard_Female_2HS_Mez::~CWizard_Female_2HS_Mez(void)
{
}

void CWizard_Female_2HS_Mez::Initialize()
{
...
CPlayerState* CWizard_Female_2HS_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CWizard_Female_2HS_Mez::Mode0()
{
...
CPlayerState* CWizard_Female_2HS_Mez::Mode1()
{
	return new CWizard_Female_2HS_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWizard_Female_2HS_Mez::Mode2()
{
	return new CWizard_Female_2HS_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWizard_Female_2HS_Mez::Mode3()
{
...
CPlayerState* CWizard_Female_2HS_Mez::SlotAction(int _iIndex)
{
...
bool CWizard_Female_2HS_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
