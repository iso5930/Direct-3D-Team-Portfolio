...
CBarbarian_Male_STF_Knockback_Loop::CBarbarian_Male_STF_Knockback_Loop(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_STF_KNOCKBACK_LOOP;
...
CBarbarian_Male_STF_Knockback_Loop::~CBarbarian_Male_STF_Knockback_Loop(void)
{
}

void CBarbarian_Male_STF_Knockback_Loop::Initialize()
{
...
CPlayerState* CBarbarian_Male_STF_Knockback_Loop::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CBarbarian_Male_STF_Knockback_End;
	}
