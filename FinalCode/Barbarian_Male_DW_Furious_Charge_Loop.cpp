...
CBarbarian_Male_DW_Furious_Charge_Loop::CBarbarian_Male_DW_Furious_Charge_Loop(void)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_DW_FURIOUS_CHARGE_LOOP;
}
...
void CBarbarian_Male_DW_Furious_Charge_Loop::Initialize()
{
...
CPlayerState* CBarbarian_Male_DW_Furious_Charge_Loop::Action()
{
