...
CMonk_Male_DW_SF_DashingStrike::CMonk_Male_DW_SF_DashingStrike()
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_SF_DASHINGSTRIKE;
}

CMonk_Male_DW_SF_DashingStrike::~CMonk_Male_DW_SF_DashingStrike(void)
{
}

void CMonk_Male_DW_SF_DashingStrike::Initialize()
{
...
CPlayerState* CMonk_Male_DW_SF_DashingStrike::Action()
{
