...
CSkeleton_Archer_Mint_Run::CSkeleton_Archer_Mint_Run(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ARCHER_MINT_RUN;
...
CSkeleton_Archer_Mint_Run::~CSkeleton_Archer_Mint_Run(void)
{
}

void CSkeleton_Archer_Mint_Run::Initialize()
{
...
CMonsterState* CSkeleton_Archer_Mint_Run::Action()
{	
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CSkeleton_Archer_Mint_Run::Mode0()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 300.0f)
	{
		...
		return new CSkeleton_Archer_Mint_Attack(0);
	}
...
CMonsterState* CSkeleton_Archer_Mint_Run::Mode1()
{
...
CMonsterState* CSkeleton_Archer_Mint_Run::Mode2()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
