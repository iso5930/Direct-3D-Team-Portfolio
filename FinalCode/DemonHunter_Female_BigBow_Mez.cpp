...
CDemonHunter_Female_BigBow_Mez::CDemonHunter_Female_BigBow_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_BIGBOW_MEZ;
...
CDemonHunter_Female_BigBow_Mez::~CDemonHunter_Female_BigBow_Mez(void)
{
}

void CDemonHunter_Female_BigBow_Mez::Initialize()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CDemonHunter_Female_BigBow_Mez::Mode0()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Mez::Mode1()
{
	return new CDemonHunter_Female_BigBow_Knockback(m_vPos, 1000.f);
}

CPlayerState* CDemonHunter_Female_BigBow_Mez::Mode2()
{
	return new CDemonHunter_Female_BigBow_Knockback(m_vPos, 1000.f);
}

CPlayerState* CDemonHunter_Female_BigBow_Mez::Mode3()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Mez::SlotAction(int _iIndex)
{
	...
	case SLOT_ID_DEMONHUNTER_GRENADES:
		return new CDemonHunter_Female_BigBow_Impale;

	case SLOT_ID_DEMONHUNTER_CHAKRAM:
		return new CDemonHunter_Female_BigBow_Impale;

	case SLOT_ID_DEMONHUNTER_FAR_ATTACK:
		return new CDemonHunter_Female_BigBow_Attack;
	...
	case SLOT_ID_DEMONHUNTER_SMOKE_SCREEN: // 연막
		return new CDemonHunter_Female_BigBow_Buff;
	...
	case SLOT_ID_DEMONHUNTER_VAULT:  // 도약
		return new CDemonHunter_Female_BigBow_BackFlip;

	case SLOT_ID_DEMONHUNTER_COMPANION: // 동료소환
		return new CDemonHunter_Female_BigBow_Companion;

	case SLOT_ID_DEMONHUNTER_MARKED_FOR_DEATH: // 죽음의 표식
		return new CDemonHunter_Female_BigBow_Caltrop;

	case SLOT_ID_DEMONHUNTER_SENTRY: // 자동쇠뇌
		return new CDemonHunter_Female_BigBow_Caltrop;

	case SLOT_ID_DEMONHUNTER_FAN_OF_KNIVES:	//부채
		return new CDemonHunter_Female_BigBow_FanOfKnives;
	...
	case SLOT_ID_DEMONHUNTER_BOLA:
		return new CDemonHunter_Female_BigBow_MultiShot;

	case SLOT_ID_DEMONHUNTER_EVASIVE_FIRE:
		return new CDemonHunter_Female_BigBow_Attack;

	case SLOT_ID_DEMONHUNTER_RAPID_FIRE:
		return new CDemonHunter_Female_BigBow_BolaSlot(_iIndex);
	...
	case SLOT_ID_DEMONHUNTER_RAIN_OF_VENGEANCE:
		return new CDemonHunter_Female_BigBow_RainOfArrow;

	case SLOT_ID_DEMONHUNTER_STRAFE:
		return new CDemonHunter_Female_BigBow_Strafe(_iIndex);
...
bool CDemonHunter_Female_BigBow_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
