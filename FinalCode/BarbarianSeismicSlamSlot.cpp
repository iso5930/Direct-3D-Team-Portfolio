...
CBarbarianSeismicSlamSlot::CBarbarianSeismicSlamSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_SEISMIC_SLAM;
...
SLOT_RESULT CBarbarianSeismicSlamSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianSeismicSlamSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianSeismicSlamSlot::End()
{
	return SLOT_RESULT_NULL;
}
