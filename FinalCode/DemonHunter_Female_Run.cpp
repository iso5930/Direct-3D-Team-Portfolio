...
CDemonHunter_Female_Run::CDemonHunter_Female_Run(int _iSlotPush)
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_RUN;
...
CDemonHunter_Female_Run::~CDemonHunter_Female_Run()
{
}

void CDemonHunter_Female_Run::Initialize()
{
...
CPlayerState* CDemonHunter_Female_Run::Action()
{
	// SlotPush
...
CPlayerState* CDemonHunter_Female_Run::Mode0()
{
	// Dir
...
CPlayerState* CDemonHunter_Female_Run::Mode1()
{
...
CPlayerState* CDemonHunter_Female_Run::SlotAction( int _iIndex )
{
...
bool CDemonHunter_Female_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
