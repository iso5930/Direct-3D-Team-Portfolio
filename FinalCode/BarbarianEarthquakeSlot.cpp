...
CBarbarianEarthquakeSlot::CBarbarianEarthquakeSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_RAGE;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_EARTHQUAKE;
...
SLOT_RESULT CBarbarianEarthquakeSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianEarthquakeSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianEarthquakeSlot::End()
{
	return SLOT_RESULT_NULL;
}
