...
CStitch_Idle::CStitch_Idle(void)
{
	// StateType
	m_eStateType = STATE_TYPE_STITCH_IDLE;
...
void CStitch_Idle::Initialize()
{
	CMonsterState::Initialize();
	
	m_pOwner->SetAnimation(0);

	CSoundMgr::GetInstance()->PlaySoundForMonster(_T("Stitch_Idle.ogg"));
}

CMonsterState* CStitch_Idle::Action()
{
	// Player
