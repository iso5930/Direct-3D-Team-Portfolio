...
CDemonHunter_Female_CB2_Strafe::CDemonHunter_Female_CB2_Strafe(int _iPushSlot)
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_CB2_STRAFE;
...
CDemonHunter_Female_CB2_Strafe::~CDemonHunter_Female_CB2_Strafe()
{
	m_pOwner->GetSlot(m_iPushSlot)->End();
}

void CDemonHunter_Female_CB2_Strafe::Initialize()
{
...
CPlayerState* CDemonHunter_Female_CB2_Strafe::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CPlayerState* CDemonHunter_Female_CB2_Strafe::Mode0()
{
...
CPlayerState* CDemonHunter_Female_CB2_Strafe::Mode1()
{
	return new CDemonHunter_Female_CB2_Idle;
}

CPlayerState* CDemonHunter_Female_CB2_Strafe::SlotAction(int _iIndex)
{
