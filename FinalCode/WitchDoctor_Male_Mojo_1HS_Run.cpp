...
CWitchDoctor_Male_Mojo_1HS_Run::CWitchDoctor_Male_Mojo_1HS_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_MOJO_1HS_RUN;
...
CWitchDoctor_Male_Mojo_1HS_Run::~CWitchDoctor_Male_Mojo_1HS_Run(void)
{
}

void CWitchDoctor_Male_Mojo_1HS_Run::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_Mojo_1HS_Run::Action()
{
...
CPlayerState* CWitchDoctor_Male_Mojo_1HS_Run::Mode0()
{
	// Dir
...
CPlayerState* CWitchDoctor_Male_Mojo_1HS_Run::Mode1()
{
...
CPlayerState* CWitchDoctor_Male_Mojo_1HS_Run::SlotAction(int _iIndex)
{
...
bool CWitchDoctor_Male_Mojo_1HS_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
