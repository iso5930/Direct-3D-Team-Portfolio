...
CCath2FToCath1F_Entrance::CCath2FToCath1F_Entrance(TCHAR* _tszObjKey, OBJ_TYPE _eObjType)
: CDynamicProb(_tszObjKey, _eObjType)
{
	...
	// ProbType
	m_eProbType = PROB_TYPE_CATH2F_TO_CATH1F_DOOR;

	// Mode
	m_iMode = 0;

	// Pos
	m_pTransformCom->m_vPos = D3DXVECTOR3(12862.0f, 40.0f, 8265.0f);
...
CCath2FToCath1F_Entrance::~CCath2FToCath1F_Entrance()
{
	Release();
}

void CCath2FToCath1F_Entrance::Initialize()
{
	CDynamicProb::Initialize();
}

int CCath2FToCath1F_Entrance::Update()
{
	CDynamicProb::Update();
...
void CCath2FToCath1F_Entrance::Render()
{
}

void CCath2FToCath1F_Entrance::Release()
{
}

void CCath2FToCath1F_Entrance::Event()
{
	// Mode
	m_iMode = 1;
...
void CCath2FToCath1F_Entrance::EventEnd()
{
}

void CCath2FToCath1F_Entrance::Mode0()
{
}

void CCath2FToCath1F_Entrance::Mode1()
{
