...
CMonk_Male_DW_FF_Knockback::CMonk_Male_DW_FF_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_FF_KNOCKBACK;
...
CMonk_Male_DW_FF_Knockback::~CMonk_Male_DW_FF_Knockback(void)
{
}

void CMonk_Male_DW_FF_Knockback::Initialize()
{
...
CPlayerState* CMonk_Male_DW_FF_Knockback::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CMonk_Male_DW_FF_Knockback_End;
	}
