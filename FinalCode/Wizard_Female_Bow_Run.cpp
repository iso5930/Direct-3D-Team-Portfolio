...
CWizard_Female_Bow_Run::CWizard_Female_Bow_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_BOW_RUN;

	// SlotPush
	m_iSlotPush = _iSlotPush;
}

CWizard_Female_Bow_Run::~CWizard_Female_Bow_Run(void)
{
}

void CWizard_Female_Bow_Run::Initialize()
{
...
CPlayerState* CWizard_Female_Bow_Run::Action()
{
...
CPlayerState* CWizard_Female_Bow_Run::Mode0()
{
	// Dir
...
CPlayerState* CWizard_Female_Bow_Run::Mode1()
{
...
CPlayerState* CWizard_Female_Bow_Run::SlotAction(int _iIndex)
{
...
bool CWizard_Female_Bow_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
