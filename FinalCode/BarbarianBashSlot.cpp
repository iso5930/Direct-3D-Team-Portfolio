...
CBarbarianBashSlot::CBarbarianBashSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_PRIMARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_BASH;
...
SLOT_RESULT CBarbarianBashSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianBashSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianBashSlot::End()
{
	return SLOT_RESULT_NULL;
}
