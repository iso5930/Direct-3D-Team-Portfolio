...
CZombie_Skinny_Male_White_Idle::CZombie_Skinny_Male_White_Idle(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_ZOMBIE_SKINNY_MALE_WHITE_IDLE;
...
CZombie_Skinny_Male_White_Idle::~CZombie_Skinny_Male_White_Idle(void)
{
}

void CZombie_Skinny_Male_White_Idle::Initialize()
{
	CMonsterState::Initialize();

	m_pOwner->SetAnimation(0);

	CSoundMgr::GetInstance()->PlaySoundForMonster(_T("Zombie_Skinny_Male_Idle.ogg"));
}

CMonsterState* CZombie_Skinny_Male_White_Idle::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CZombie_Skinny_Male_White_Idle::Mode0()
{	
			...
			if(m_pPathFindCom->IsMove(&vNextPos))
			{
				...
				if(!Equals(vDir.x, 0.0f, MIN_EPSILON) || !Equals(vDir.z, 0.0f, MIN_EPSILON))
				{
					...
					if(Equals(fDotZ, 1.0f, MAX_EPSILON))
					{
						...
						//Walk
						return new CZombie_Skinny_Male_White_Walk1(0);
...
CMonsterState* CZombie_Skinny_Male_White_Idle::Mode1()
{
...
CMonsterState* CZombie_Skinny_Male_White_Idle::Mode2()
{
	...
	if(m_fWorryTime > m_fWorryMaxTime)
	{
		...
		case 0:
			m_fWorryTime = 0.0f;
			m_bWorry = true;
			return new CZombie_Skinny_Male_White_Attack1;
		case 1:
			m_fWorryTime = 0.0f;
			m_bWorry = true;
			return new CZombie_Skinny_Male_White_Attack2;
		case 2:
			m_fWorryTime = 0.0f;
			m_bWorry = true;
			return new CZombie_Skinny_Male_White_Attack3;
		case 3:
			m_fWorryTime = 0.0f;
			m_bWorry = true;
			return new CZombie_Skinny_Male_White_Attack4;
		case 4:
			m_fWorryTime = 0.0f;
			m_bWorry = true;
			return new CZombie_Skinny_Male_White_Walk1(2);
		}
	}
