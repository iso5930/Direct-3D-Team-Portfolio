...
CWizard_Female_1HS_Channel::CWizard_Female_1HS_Channel(int _iPushSlot)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_1HS_CHANNEL;
...
CWizard_Female_1HS_Channel::~CWizard_Female_1HS_Channel(void)
{
...
void CWizard_Female_1HS_Channel::Initialize()
{
...
CPlayerState* CWizard_Female_1HS_Channel::Action()
{
...
CPlayerState* CWizard_Female_1HS_Channel::Mode0()
{
...
CPlayerState* CWizard_Female_1HS_Channel::Mode1()
{
...
CPlayerState* CWizard_Female_1HS_Channel::SlotAction(int _iIndex)
{
	...
	case 	SLOT_ID_WIZARD_MAGIC_MISSILE:			// 마력탄
		if (CItemMgr::GetInstance()->GetItemInEquip(_iIndex) != NULL && CItemMgr::GetInstance()->GetItemInEquip(_iIndex)->dwItemID & WEAPON_ID_WAND)
		{
			int iRand = 0;
			iRand = rand() % 2;
			if (iRand ==0 )
...
bool CWizard_Female_1HS_Channel::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
