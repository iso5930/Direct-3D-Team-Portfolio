...
CDemonHunter_Female_BigBow_Knockback::CDemonHunter_Female_BigBow_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_KNOCKBACK;
...
CDemonHunter_Female_BigBow_Knockback::~CDemonHunter_Female_BigBow_Knockback()
{
}

void CDemonHunter_Female_BigBow_Knockback::Initialize()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Knockback::Action()
{
