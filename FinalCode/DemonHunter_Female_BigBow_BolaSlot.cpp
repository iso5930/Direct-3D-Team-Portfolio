...
CDemonHunter_Female_BigBow_BolaSlot::CDemonHunter_Female_BigBow_BolaSlot(int _iPushSlot)
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_BIGBOW_BOLASLOT;
...
CDemonHunter_Female_BigBow_BolaSlot::~CDemonHunter_Female_BigBow_BolaSlot()
{
...
void CDemonHunter_Female_BigBow_BolaSlot::Initialize()
{
...
CPlayerState* CDemonHunter_Female_BigBow_BolaSlot::Action()
{
...
CPlayerState* CDemonHunter_Female_BigBow_BolaSlot::Mode0()
{
...
CPlayerState* CDemonHunter_Female_BigBow_BolaSlot::Mode1()
{
	// Find Priority Key and SlotNo
	int iSlotNum = CPlayerState::UsingKeyMouse();
...
CPlayerState* CDemonHunter_Female_BigBow_BolaSlot::SlotAction(int _iIndex)
{
...
bool CDemonHunter_Female_BigBow_BolaSlot::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
