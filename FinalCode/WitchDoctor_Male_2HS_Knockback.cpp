...
CWitchDoctor_Male_2HS_Knockback::CWitchDoctor_Male_2HS_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_2HS_KNOCKBACK;
...
CWitchDoctor_Male_2HS_Knockback::~CWitchDoctor_Male_2HS_Knockback(void)
{
}

void CWitchDoctor_Male_2HS_Knockback::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_2HS_Knockback::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CWitchDoctor_Male_2HS_Knockback_End;
	}
