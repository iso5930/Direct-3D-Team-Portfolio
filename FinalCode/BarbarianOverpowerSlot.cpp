...
CBarbarianOverpowerSlot::CBarbarianOverpowerSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_MIGHT;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_OVERPOWER;
...
SLOT_RESULT CBarbarianOverpowerSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianOverpowerSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianOverpowerSlot::End()
{
	return SLOT_RESULT_NULL;
}
