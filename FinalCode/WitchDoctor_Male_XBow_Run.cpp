...
CWitchDoctor_Male_XBow_Run::CWitchDoctor_Male_XBow_Run(int _iSlotPush)
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_XBOW_RUN;
	// SlotPush
	m_iSlotPush = _iSlotPush;
}

CWitchDoctor_Male_XBow_Run::~CWitchDoctor_Male_XBow_Run(void)
{
}

void CWitchDoctor_Male_XBow_Run::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_XBow_Run::Action()
{
...
CPlayerState* CWitchDoctor_Male_XBow_Run::Mode0()
{
	// Dir
...
CPlayerState* CWitchDoctor_Male_XBow_Run::Mode1()
{
...
CPlayerState* CWitchDoctor_Male_XBow_Run::SlotAction(int _iIndex)
{
...
bool CWitchDoctor_Male_XBow_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
