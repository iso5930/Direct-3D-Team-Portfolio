...
CSkeleton_Shield_Blue_Walk::CSkeleton_Shield_Blue_Walk(int _iMode)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_SHIELD_BLUE_WALK;
...
CSkeleton_Shield_Blue_Walk::~CSkeleton_Shield_Blue_Walk(void)
{
}

void CSkeleton_Shield_Blue_Walk::Initialize()
{
...
CMonsterState* CSkeleton_Shield_Blue_Walk::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CMonsterState* CSkeleton_Shield_Blue_Walk::Mode0()
{
	//비전투
	...
	{	
		return new CSkeleton_Shield_Blue_Walk(1);
	}
...
CMonsterState* CSkeleton_Shield_Blue_Walk::Mode1()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
	...
	if(D3DXVec3Length(&(pPlayerTransformCom->m_vPos - m_pTransformCom->m_vPos)) < 80.0f)
	{
		...
		return new CSkeleton_Shield_Blue_Attack;
	}
...
CMonsterState* CSkeleton_Shield_Blue_Walk::Mode2()
{
	//전투
	// Player
	CObject* pPlayer = NULL;
