...
CDemonHunter_Female_Bow_Knockback::CDemonHunter_Female_Bow_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_BOW_KNOCKBACK;
...
CDemonHunter_Female_Bow_Knockback::~CDemonHunter_Female_Bow_Knockback()
{
}

void CDemonHunter_Female_Bow_Knockback::Initialize()
{
...
CPlayerState* CDemonHunter_Female_Bow_Knockback::Action()
{
