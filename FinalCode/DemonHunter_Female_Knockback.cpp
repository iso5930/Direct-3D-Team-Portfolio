...
CDemonHunter_Female_Knockback::CDemonHunter_Female_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	// StateType
...
CDemonHunter_Female_Knockback::~CDemonHunter_Female_Knockback()
{
}

void CDemonHunter_Female_Knockback::Initialize()
{
...
CPlayerState* CDemonHunter_Female_Knockback::Action()
{
