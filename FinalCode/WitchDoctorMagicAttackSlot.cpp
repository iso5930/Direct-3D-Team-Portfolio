...
CWitchDoctorMagicAttackSlot::CWitchDoctorMagicAttackSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_WITCHDOCTOR_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_WITCHDOCTOR_MAGIC_ATTACK;
...
SLOT_RESULT CWitchDoctorMagicAttackSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CWitchDoctorMagicAttackSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CWitchDoctorMagicAttackSlot::End()
{
	return SLOT_RESULT_NULL;
}
