...
CDemonHunter_Female_BigBow_Run::CDemonHunter_Female_BigBow_Run(int _iSlotPush)
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_BIGBOW_RUN;

	// SlotPush
	m_iSlotPush = _iSlotPush;
}

CDemonHunter_Female_BigBow_Run::~CDemonHunter_Female_BigBow_Run()
{
}

void CDemonHunter_Female_BigBow_Run::Initialize()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Run::Action()
{
	// SlotPush
...
CPlayerState* CDemonHunter_Female_BigBow_Run::Mode0()
{
	// Dir
...
CPlayerState* CDemonHunter_Female_BigBow_Run::Mode1()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Run::SlotAction(int _iIndex)
{
...
bool CDemonHunter_Female_BigBow_Run::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
