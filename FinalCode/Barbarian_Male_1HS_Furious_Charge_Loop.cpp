...
CBarbarian_Male_1HS_Furious_Charge_Loop::CBarbarian_Male_1HS_Furious_Charge_Loop(void)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_1HS_FURIOUS_CHARGE_LOOP;
...
void CBarbarian_Male_1HS_Furious_Charge_Loop::Initialize()
{
...
CPlayerState* CBarbarian_Male_1HS_Furious_Charge_Loop::Action()
{
...
CPlayerState* CBarbarian_Male_1HS_Furious_Charge_Loop::Mode0()
{
	++m_iMode;
	m_fTime = 0.0f;
...
CPlayerState* CBarbarian_Male_1HS_Furious_Charge_Loop::Mode1()
{
	return NULL;
}
