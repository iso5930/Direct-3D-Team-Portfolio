...
CWizard_Female_Bow_Mez::CWizard_Female_Bow_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_WIZARD_FEMALE_BOW_MEZ;
...
CWizard_Female_Bow_Mez::~CWizard_Female_Bow_Mez(void)
{
}

void CWizard_Female_Bow_Mez::Initialize()
{
...
CPlayerState* CWizard_Female_Bow_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CWizard_Female_Bow_Mez::Mode0()
{
...
CPlayerState* CWizard_Female_Bow_Mez::Mode1()
{
	return new CWizard_Female_Bow_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWizard_Female_Bow_Mez::Mode2()
{
	return new CWizard_Female_Bow_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWizard_Female_Bow_Mez::Mode3()
{
...
CPlayerState* CWizard_Female_Bow_Mez::SlotAction(int _iIndex)
{
...
bool CWizard_Female_Bow_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
