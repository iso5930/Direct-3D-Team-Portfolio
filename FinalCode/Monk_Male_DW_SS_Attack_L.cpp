...
CMonk_Male_DW_SS_Attack_L::CMonk_Male_DW_SS_Attack_L(void)
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_SS_ATTACK_L;
}
...
void CMonk_Male_DW_SS_Attack_L::Initialize()
{
...
CPlayerState* CMonk_Male_DW_SS_Attack_L::Action()
{
	if(m_pAnimController->m_dFrameTime - 0.25 <= m_pAnimController->GetTrackPos())
	{
		...
		{
			return new CMonk_Male_DW_SS_Attack_R;
		}
		else
			return new CMonk_Male_DW_SS_Idle;		
	}
