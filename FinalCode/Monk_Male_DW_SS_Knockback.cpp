...
CMonk_Male_DW_SS_Knockback::CMonk_Male_DW_SS_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_SS_KNOCKBACK;
...
CMonk_Male_DW_SS_Knockback::~CMonk_Male_DW_SS_Knockback(void)
{
}

void CMonk_Male_DW_SS_Knockback::Initialize()
{
...
CPlayerState* CMonk_Male_DW_SS_Knockback::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CMonk_Male_DW_SS_Knockback_End;
	}
	return NULL;
}
