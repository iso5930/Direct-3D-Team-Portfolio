...
CWitchDoctor_Male_Bow_Knockback::CWitchDoctor_Male_Bow_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_BOW_KNOCKBACK;
...
CWitchDoctor_Male_Bow_Knockback::~CWitchDoctor_Male_Bow_Knockback(void)
{
}

void CWitchDoctor_Male_Bow_Knockback::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_Bow_Knockback::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CWitchDoctor_Male_Bow_Knockback_End;
	}
