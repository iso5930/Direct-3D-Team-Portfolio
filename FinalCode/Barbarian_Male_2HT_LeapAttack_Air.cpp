...
CBarbarian_Male_2HT_LeapAttack_Air::CBarbarian_Male_2HT_LeapAttack_Air(void)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_2HT_LEAPATTACK_AIR;
}
...
void CBarbarian_Male_2HT_LeapAttack_Air::Initialize()
{
...
CPlayerState* CBarbarian_Male_2HT_LeapAttack_Air::Action()
{
