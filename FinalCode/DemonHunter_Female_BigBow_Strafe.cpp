...
CDemonHunter_Female_BigBow_Strafe::CDemonHunter_Female_BigBow_Strafe(int _iPushSlot)
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_BIGBOW_STRAFE;
...
CDemonHunter_Female_BigBow_Strafe::~CDemonHunter_Female_BigBow_Strafe()
{
	m_pOwner->GetSlot(m_iPushSlot)->End();
}

void CDemonHunter_Female_BigBow_Strafe::Initialize()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Strafe::Action()
{
	switch(m_iMode)
	{
	case 0:
...
CPlayerState* CDemonHunter_Female_BigBow_Strafe::Mode0()
{
...
CPlayerState* CDemonHunter_Female_BigBow_Strafe::Mode1()
{
	return new CDemonHunter_Female_BigBow_Idle;
}

CPlayerState* CDemonHunter_Female_BigBow_Strafe::SlotAction(int _iIndex)
{	
