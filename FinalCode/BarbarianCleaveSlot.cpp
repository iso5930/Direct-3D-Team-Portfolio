...
CBarbarianCleaveSlot::CBarbarianCleaveSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_PRIMARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_CLEAVE;
...
SLOT_RESULT CBarbarianCleaveSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianCleaveSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianCleaveSlot::End()
{
	return SLOT_RESULT_NULL;
}
