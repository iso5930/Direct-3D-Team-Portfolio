...
CSkeleton_Archer_Mint_Death::CSkeleton_Archer_Mint_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ARCHER_MINT_DEATH;
...
void CSkeleton_Archer_Mint_Death::Initialize()
{
...
CMonsterState* CSkeleton_Archer_Mint_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
