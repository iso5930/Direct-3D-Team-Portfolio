...
CSkeleton_Axe_Blue_Death::CSkeleton_Axe_Blue_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_AXE_BLUE_DEATH;
...
void CSkeleton_Axe_Blue_Death::Initialize()
{
	...
	CSoundMgr::GetInstance()->PlaySoundForMonster(_T("Skeleton_Axe_Death.ogg"));
}

CMonsterState* CSkeleton_Axe_Blue_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
