...
CDemonHunter_Female_BigBow_BackFlip::CDemonHunter_Female_BigBow_BackFlip()
{
	// StateType
...
void CDemonHunter_Female_BigBow_BackFlip::Initialize()
{
...
CPlayerState* CDemonHunter_Female_BigBow_BackFlip::Action()
{
