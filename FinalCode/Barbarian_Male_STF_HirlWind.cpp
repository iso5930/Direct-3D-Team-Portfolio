...
CBarbarian_Male_STF_HirlWind::CBarbarian_Male_STF_HirlWind(int _iPushSlot)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_STF_HIRLWIND;
...
CBarbarian_Male_STF_HirlWind::~CBarbarian_Male_STF_HirlWind(void)
{
	m_pOwner->GetSlot(m_iPushSlot)->End();
}

void CBarbarian_Male_STF_HirlWind::Initialize()
{
...
CPlayerState* CBarbarian_Male_STF_HirlWind::Action()
{
...
CPlayerState* CBarbarian_Male_STF_HirlWind::Mode0()
{
	if(m_pAnimController->m_dFrameTime <= m_pAnimController->GetTrackPos())
	{
		return new CBarbarian_Male_STF_HirlWind(m_iPushSlot);
	}

	return NULL;
}

CPlayerState* CBarbarian_Male_STF_HirlWind::Mode1()
{
	return new CBarbarian_Male_STF_Idle;
}

CPlayerState* CBarbarian_Male_STF_HirlWind::SlotAction(int _iIndex)
{
