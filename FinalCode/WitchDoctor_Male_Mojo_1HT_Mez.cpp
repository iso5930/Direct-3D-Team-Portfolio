...
CWitchDoctor_Male_Mojo_1HT_Mez::CWitchDoctor_Male_Mojo_1HT_Mez(int _iMez , D3DXVECTOR3& _vPos)
{
	m_eStateType = STATE_TYPE_WITCHDOCTOR_MALE_MOJO_1HT_MEZ;
...
CWitchDoctor_Male_Mojo_1HT_Mez::~CWitchDoctor_Male_Mojo_1HT_Mez(void)
{
}

void CWitchDoctor_Male_Mojo_1HT_Mez::Initialize()
{
...
CPlayerState* CWitchDoctor_Male_Mojo_1HT_Mez::Action()
{
	switch (m_iMez)
	{
...
CPlayerState* CWitchDoctor_Male_Mojo_1HT_Mez::Mode0()
{
...
CPlayerState* CWitchDoctor_Male_Mojo_1HT_Mez::Mode1()
{
	return new CWitchDoctor_Male_Mojo_1HT_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWitchDoctor_Male_Mojo_1HT_Mez::Mode2()
{
	return new CWitchDoctor_Male_Mojo_1HT_Knockback(m_vPos, 1000.f);
}

CPlayerState* CWitchDoctor_Male_Mojo_1HT_Mez::Mode3()
{
...
CPlayerState* CWitchDoctor_Male_Mojo_1HT_Mez::SlotAction(int _iIndex)
{
	...
	case SLOT_ID_WITCHDOCTOR_POISON_DART:			// 독침
		return new CWitchDoctor_Male_Mojo_1HT_Blow;
	case SLOT_ID_WITCHDOCTOR_CORPSE_SPIDERS:		// 시체 거미
		return new CWitchDoctor_Male_Mojo_1HT_FireBall;
	case SLOT_ID_WITCHDOCTOR_PLAGUE_OF_TOADS:		// 역병 두꺼비
		return new CWitchDoctor_Male_Mojo_1HT_Summon_Charger;
	case SLOT_ID_WITCHDOCTOR_FIREBOMB:				// 불폭탄
		return new CWitchDoctor_Male_Mojo_1HT_FireBall;
	case SLOT_ID_WITCHDOCTOR_PUNCH:					// 주먹질
		return new CWitchDoctor_Male_Mojo_1HT_Attack;
	...
	case SLOT_ID_WITCHDOCTOR_FIREBATS:				// 불박쥐
		return new CWitchDoctor_Male_Mojo_1HT_Channel;
	case SLOT_ID_WITCHDOCTOR_HAUNT:					// 혼령 출몰
		return new CWitchDoctor_Male_Mojo_1HT_Horrify;
	case SLOT_ID_WITCHDOCTOR_LOCUST_SWARM:			// 메뚜기 떼
		return new CWitchDoctor_Male_Mojo_1HT_AcidCloud_barf;
	case SLOT_ID_WITCHDOCTOR_SUMMON_ZOMBIE_DOGS:	// 좀비 들개 소환
		return new CWitchDoctor_Male_Mojo_1HT_Summon;
	...
	case SLOT_ID_WITCHDOCTOR_SOUL_HARVEST:			// 혼령 수확
		return new CWitchDoctor_Male_Mojo_1HT_Soul_Harvest;
	...
	case SLOT_ID_WITCHDOCTOR_SPIRIT_BARRAGE:		// 혼령 공세
		return new CWitchDoctor_Male_Mojo_1HT_FastCast;
	...
	case SLOT_ID_WITCHDOCTOR_FETISH_ARMY:			// 우상족 군대
		return new CWitchDoctor_Male_Mojo_1HT_FlayerArmy;	
...
bool CWitchDoctor_Male_Mojo_1HT_Mez::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
