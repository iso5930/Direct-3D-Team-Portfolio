...
CDemonHunter_Female_CB1_Idle::CDemonHunter_Female_CB1_Idle()
{
	// StateType
	m_eStateType = STATE_TYPE_DEMONHUNTER_FEMALE_CB1_IDLE;
...
void CDemonHunter_Female_CB1_Idle::Initialize()
{
...
CPlayerState* CDemonHunter_Female_CB1_Idle::Action()
{
	for (int i = 0 ; i < SKILL_TYPE_END ; ++i)
	{
		if (m_pOwner->IsMez(i))
		{
			return new CDemonHunter_Female_CB1_Mez(i , D3DXVECTOR3(0.f , 0.f , 0.f ));
		}
	}
	switch(m_iMode)
	{
...
CPlayerState* CDemonHunter_Female_CB1_Idle::Mode0()
{
...
CPlayerState* CDemonHunter_Female_CB1_Idle::Mode1()
{
...
CPlayerState* CDemonHunter_Female_CB1_Idle::SlotAction( int _iIndex )
{
...
bool CDemonHunter_Female_CB1_Idle::IsSlotRange(int _iIndex)
{
	//눌린 키 저장 
