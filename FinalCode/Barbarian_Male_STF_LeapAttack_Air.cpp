...
CBarbarian_Male_STF_LeapAttack_Air::CBarbarian_Male_STF_LeapAttack_Air(void)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_STF_LEAPATTACK_AIR;
}
...
void CBarbarian_Male_STF_LeapAttack_Air::Initialize()
{
...
CPlayerState* CBarbarian_Male_STF_LeapAttack_Air::Action()
{
