...
CBarbarianPotionSlot::CBarbarianPotionSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_END;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_POTION;
...
SLOT_RESULT CBarbarianPotionSlot::Begin(int _iMode)
{
	// Check Enable
	if(m_bEnable == false)
	{
...
SLOT_RESULT CBarbarianPotionSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianPotionSlot::End()
{
	return SLOT_RESULT_NULL;
}