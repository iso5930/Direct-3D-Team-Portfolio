...
CMonk_Male_1HS_Knockback::CMonk_Male_1HS_Knockback(D3DXVECTOR3& _vDir , float _fPower )
{
	m_eStateType = STATE_TYPE_MONK_MALE_1HS_KNOCKBACK;
...
CMonk_Male_1HS_Knockback::~CMonk_Male_1HS_Knockback(void)
{
}

void CMonk_Male_1HS_Knockback::Initialize()
{
...
CPlayerState* CMonk_Male_1HS_Knockback::Action()
{
	...
	if (m_fTime > 0.1f )
	{
		return new CMonk_Male_1HS_Knockback_End;
	}
