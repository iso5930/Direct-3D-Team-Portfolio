...
CSkeleton_Archer_Brown_Death::CSkeleton_Archer_Brown_Death(void)
{
	// StateType
	m_eStateType = STATE_TYPE_SKELETON_ARCHER_BROWN_DEATH;
...
void CSkeleton_Archer_Brown_Death::Initialize()
{
...
CMonsterState* CSkeleton_Archer_Brown_Death::Action()
{
	if(!m_bDeath)
	{
		m_pOwner->Death();
