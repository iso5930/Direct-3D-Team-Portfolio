...
CBarbarianPunchSlot::CBarbarianPunchSlot()
{
	// SlotType
	m_eSlotType = SLOT_TYPE_BARBARIAN_SECONDARY;

	// SlotID
	m_eSlotID = SLOT_ID_BARBARIAN_PUNCH;
...
SLOT_RESULT CBarbarianPunchSlot::Begin(int _iMode)
{
	// Check Enable
	if (!m_bEnable)
	{
...
SLOT_RESULT CBarbarianPunchSlot::Action()
{
	return SLOT_RESULT_NULL;
}

SLOT_RESULT CBarbarianPunchSlot::End()
{
	return SLOT_RESULT_NULL;
}
