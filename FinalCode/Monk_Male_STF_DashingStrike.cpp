...
CMonk_Male_STF_DashingStrike::CMonk_Male_STF_DashingStrike()
{
	m_eStateType = STATE_TYPE_MONK_MALE_STF_DASHINGSTRIKE;
}

CMonk_Male_STF_DashingStrike::~CMonk_Male_STF_DashingStrike(void)
{
}

void CMonk_Male_STF_DashingStrike::Initialize()
{
...
CPlayerState* CMonk_Male_STF_DashingStrike::Action()
{
