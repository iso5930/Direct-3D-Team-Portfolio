...
CMonk_Male_DW_FF_Attack_R::CMonk_Male_DW_FF_Attack_R(void)
{
	m_eStateType = STATE_TYPE_MONK_MALE_DW_FF_ATTACK_R;
}
...
void CMonk_Male_DW_FF_Attack_R::Initialize()
{
...
CPlayerState* CMonk_Male_DW_FF_Attack_R::Action()
{
