...
CBarbarian_Male_2HS_LeapAttack_Air::CBarbarian_Male_2HS_LeapAttack_Air(void)
{
	m_eStateType = STATE_TYPE_BARBARIAN_MALE_2HS_LEAPATTACK_AIR;
}
...
void CBarbarian_Male_2HS_LeapAttack_Air::Initialize()
{
...
CPlayerState* CBarbarian_Male_2HS_LeapAttack_Air::Action()
{
